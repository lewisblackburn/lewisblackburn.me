...
const NowPlaying = () => {
    const { data: response } = useSWR<ApiResponseSuccess<GetSongResponse>>(
    ...
    return (
        <div className="flex items-center gap-4">
            ...
            <div className="inline-flex w-full items-center justify-start gap-1 text-sm md:justify-start">
                <p>
