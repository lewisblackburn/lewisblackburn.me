...
export default function NotFound() {
    return (
        <div className="py-64 bg-background flex items-center justify-center w-full z-10">
            ...
            <div className="text-center flex flex-col gap-4 max-w-xs mx-auto relative">
                ...
                <p className="text-muted-foreground text-base leading-relaxed text-center tracking-tight text-balance">
                    ...
                    for. The page might have been moved, deleted, or you entered
                    the wrong URL.
                </p>
                <Button
                    asChild
                    className="w-full rounded-lg h-9 drop-shadow-lg"
                >
